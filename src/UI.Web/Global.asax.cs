...
namespace UI.Web
{
    public class MvcApplication : HttpApplication
    {
        ...
        protected void Application_AcquireRequestState()
        {
            ...
            {
                Context.User = NinjectSetup.Kernel.Get<IUserRepository>().GetOne(x => x.Email == User.Identity.Name);
            }

            // Set culture for current request
            NinjectSetup.Kernel.Get<ICultureService>().SetCulture(new HttpContextWrapper(HttpContext.Current));
        }
        ...
        protected void Application_Error()
        {
            ...
            var logger = NinjectSetup.Kernel.Get<ILogger>();
